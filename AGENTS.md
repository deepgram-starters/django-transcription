...
Django demo app for Deepgram Transcription.
...
```
feat(django-transcription): add diarization support
fix(django-transcription): resolve WebSocket close handling
refactor(django-transcription): simplify session endpoint
